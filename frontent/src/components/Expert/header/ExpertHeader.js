      ...
      <div className="header__top">
        <Container>
          <Row>
            ...
            <Col lg="6" md="6" sm="6">
            {isAuthenticated ? (
                <Link to="/expert_login" className=" d-flex align-items-center gap-1"  onClick={logout}>
                <i className="ri-login-circle-line" ></i> Logout
              </Link>
            ) : 
              <div className="header__top__right d-flex align-items-center justify-content-end gap-3">
                <Link to="/expert_login" className=" d-flex align-items-center gap-1">
                  <i className="ri-login-circle-line"></i>Logout
                </Link>
